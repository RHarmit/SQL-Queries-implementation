...
salary int not null,
dept_name varchar(50) references UniDB_Department(dept_name)
);
...
(101,'Jimmy Tent',34535,'Nursing'),
(102,'Deeps Ahuja',34535,'Nursing'),
(103,'Vipul Tembey',45345,'Medicine'),
(104,'Tushar Rastogi',23423,'Public Affairs'),
(105,'Rhea Dsouza',34345,'Management Administration'),
(106,'Linda Hill',67567,'Social Works'),
(107,'Elizabeth Carter',34554,'Pharmacy'),
(108,'Robert Downey',67867,'Urban Planning'),
(109,'Chris Evans',23434,'Music'),
(110,'Tyron Smith',45674,'Dentistry'),
(111,'Ckimbelie Parera',35463,'Design and Arts'),
(112,'Bryna Dsouza',24353,'Law'),
(113,'Twinkle Sequira',79766,'Aeronautics Engineering'),
...
(117,'Dyone Lobo',45658,'Business'),
(118,'Rachel Craster',34536,'Architecture'),
(119,'Kathy Fernandez',34646,'Management'),
(120,'Sonal Paul',344645,'Applied Health Sciences');
...
Insert into UniDB_Course Values (301,'Structure Design',2,NULL,'Architecture and Planning'),
...
INSERT INTO UniDB_classroom VALUES ('A',102,80),
('A',105,NULL),
('B',203,130),
('B',206,125),
('C',201,58),
